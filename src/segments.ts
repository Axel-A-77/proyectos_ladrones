...
export const DEMO_SEGMENTS: Segment[] = [
  {id: 'titulo', kind: 'TITLE', scene: '00_titulo', tone: 'sun', from: 0, to: 4, note: 'Título (se dibuja)'},
...
export const SEGMENTS: Segment[] = [
  {id: 'titulo', kind: 'TITLE', scene: '00_titulo', tone: 'sun', from: 0, to: t(0, 4), note: 'Título'},
  ...
  {id: 'r-gobernador', kind: 'ANIM', scene: 'gobernador', tone: 'sun', from: t(3, 22), to: t(4, 50)},
  ...
  {id: 's25', kind: 'ANIM', scene: '25_orquesta', tone: 'sun', from: t(12, 18), to: t(12, 54)},
  ...
  {id: 'papa-tesis', kind: 'PAPA', from: t(15, 17), to: t(15, 32), note: 'tesis: ladrones de cuello y corbata ⭐'},
