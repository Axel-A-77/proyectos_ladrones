...
// Montaje editorial:
// - El presentador aparece en saludos, tesis, entradas de capítulo y respiraciones humanas.
// - Las láminas ilustradas cubren metáforas, comparaciones y cadenas causales.
// - Se evita dejar más de ~90 s sin volver al rostro del presentador en los bloques largos.
export const SEGMENTS: Segment[] = [
  {id: 'titulo', kind: 'TITLE', scene: '00_titulo', tone: 'sun', from: 0, to: t(0, 4), note: 'Título y mapa visual'},
  {id: 'papa-intro', kind: 'PAPA', from: t(0, 4), to: t(0, 17), note: 'Saludo inicial'},
  {id: 's01', kind: 'ANIM', scene: '01_puerta_sillon_billetera', tone: 'sun', from: t(0, 17), to: t(0, 27)},
  {id: 'papa-reflexion', kind: 'PAPA', from: t(0, 27), to: t(0, 47), note: 'Invitación y tesis humana'},
  {id: 'intro-reflexion', kind: 'ANIM', scene: '00_reflexion', tone: 'sun', from: t(0, 47), to: t(1, 9), note: 'Patria, robo y normalización'},
  ...
  {id: 'papa-gobernador-cierre', kind: 'PAPA', from: t(4, 43), to: t(4, 50), note: 'Remate del capítulo y respiración visual'},
  ...
  {id: 'papa-ecosistema', kind: 'PAPA', from: t(12, 18), to: t(12, 28), note: 'Introduce la red de cómplices'},
  ...
  {id: 'papa-excel', kind: 'PAPA', from: t(13, 28), to: t(13, 34), note: 'Introduce el archivo de gastos'},
  ...
  {id: 'papa-tesis', kind: 'PAPA', from: t(15, 17), to: t(15, 32), note: 'Tesis final: ciudadanía y autoridades'},
  {id: 's31', kind: 'ANIM', scene: '31_diogenes_lampara', tone: 'sun', from: t(15, 32), to: t(16, 11)},
  {id: 'papa-cierre', kind: 'PAPA', from: t(16, 11), to: t(16, 35), note: 'Cierre y saludo por el Día del Padre'},
];
