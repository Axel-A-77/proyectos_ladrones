...
export const IntroReflectionScene: React.FC = () => (
  <IllustratedSlide title="EL VERDADERO PELIGRO">
    ...
    <FlowItem inAt={8} enter="scale" style={{left: 490, top: 330}}><Arrow from={[0, 0]} to={[155, 0]} color={COLORS.red} /></FlowItem>
    ...
    <FlowItem inAt={22} enter="scale" style={{left: 1095, top: 330}}><Arrow from={[0, 0]} to={[150, 0]} color={COLORS.red} /></FlowItem>
